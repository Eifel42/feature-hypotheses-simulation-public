...
FIXED_SPRINT_LENGTH_WEEKS = float(DeliveryRiskConfig().sprint_length_weeks)
...
class SprintOverrunService:
    ...
    def planned_sprints_for_weeks(
        ...
        Sprint length is fixed to two weeks.
        Partial sprints are rounded up so a 5-week effort
        reserves 3 sprints.
        """
        sprint_weeks = FIXED_SPRINT_LENGTH_WEEKS
    ...
    def simulate_delivery(
        *,
        ...
        cost_per_sprint = weekly_burn * FIXED_SPRINT_LENGTH_WEEKS
