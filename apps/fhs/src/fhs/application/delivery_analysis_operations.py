...
"""Delivery risk, sprint overruns, and profitability analysis operations."""
...
class DeliveryAnalysisOperations:
    """Delivery risk, sprint overruns, and profitability analysis with explicit context."""
    ...
    def _delivery_business_value_scenarios(
        ...
        *,
        ...
        """Return delivery-specific business-value scenarios with configured length."""
    ...
    def simulate_risk(
        ...
        *,
        ...
        sprint_plans = SprintOverrunService.compute_sprint_plans(selected_features)
        if not sprint_plans:
            return {}  # pragma: no cover - defensive
    ...
    def cost_comparison_rows(
        ...
        """Notebook-ready feature-investment vs delivery-burn rows per feature."""
        rows: list[tuple[str, ...]] = []
        for feature in features:
    ...
    def delivery_cost_risk_rows(
        ...
        """Notebook-ready VaR/CVaR delivery cost table rows per feature.
    ...
    def min_cost_cvar_selection(
        ...
        measure: it captures the expected delivery cost across the entire worst
