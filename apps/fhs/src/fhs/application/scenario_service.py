...
class ScenarioService:
    ...
    def __init__(self, repository: FeatureRepository | None = None):
        ...
        if repository is None:
            ...
            from fhs.infra.repositories import (  # pragma: no cover - defensive
    ...
    def load_scenario(
        ...
        if path:
            ...
            if path.is_file():  # pragma: no cover - defensive
                ...
                from fhs.core.model import (  # pragma: no cover - defensive
                    ScenarioConfig,
                )
        ...
        deployment_risk_config = config.get(
            "deployment_risk", config.get("delivery_risk")
        )
        ...
        return ScenarioContext(
            ...
            delivery_config=DeliveryRiskConfig(**(deployment_risk_config or {})),
        )
