...
def plot_risk_layer_decay(
    ...
    *,
    ...
    layer_names = [
        row.layer.replace(" (no risk)", "").replace(" (all risks)", "")
...
def plot_cost_comparison(
    delivery_results: dict[str, DeliverySimulationResult],
    *,
    title: str = "Planned vs Simulated Delivery Burn Cost",
) -> Figure:
    """Grouped bar chart comparing planned and expected delivery burn cost."""
    ordered_names = sorted(delivery_results)
...
def plot_delivery_market_resilience(
    ...
    *,
    ...
    title: str = "Portfolio Resilience: Delivery Risk x Market Risk",
    ...
    ax.set_ylabel("Delivery risk scenario", fontsize=12, labelpad=12, fontweight="bold")
    ax.set_title(
