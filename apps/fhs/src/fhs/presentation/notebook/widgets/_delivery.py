...
class _DeliveryMixin:
    ...
    def delivery_risk_configuration(
        ...
        *,
        title: str = "Delivery-Risk Configuration Overview",
    ) -> None:
        """Render the standard delivery-risk configuration overview table."""
        ...
        rows = [
            ...
            (
                ...
                "Fixed cadence for all delivery plans",
            ),
            (
    ...
    def cost_risk_selection(
        ...
        *,
        ...
        objective: str = "Minimise portfolio CVaR 95% (worst-5% average delivery cost) — delivery simulation",
    ) -> None:
        """Render cost-risk optimisation result based on delivery cost scenarios.

        Shows selected features and portfolio delivery cost risk metrics.
        No business value metrics — purely delivery cost view.
        """
