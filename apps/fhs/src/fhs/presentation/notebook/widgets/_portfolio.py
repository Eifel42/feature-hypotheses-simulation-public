...
class _PortfolioMixin:
    ...
    def _sprint_plan_rows(
        ...
        for feature in features:
            ...
            planned_sprints = max(1, math.ceil(planned_weeks / _SPRINT_LENGTH_WEEKS))
            rows.append(
                (
    ...
    def cost_comparison(
        ...
        delivery_results: dict[str, Any],
        *,
        title: str = "Feature Investment vs Delivery Burn Cost",
    ) -> None:
        ...
        self.sensitivity(
            ...
            headers=(
                ...
                "Planned delivery burn",
                "Expected delivery burn",
                "P95 delivery burn",
                "Burn uplift vs plan",
            ),
            title=title,
    ...
    def delivery_cost_risk(
        ...
        delivery_results: dict[str, Any],
        *,
        title: str = "Delivery Cost Risk — Cost at Risk (CaR) & CVaR",
    ) -> None:
        """Render a VaR/CVaR delivery cost risk table.
    ...
    def feature_profitability_matrix(
        ...
        *,
        ...
        """Render the standard delivery-risk profitability matrix per feature."""
        self.sensitivity(
            rows,
            (
                "Feature",
            ...
            grid_items.append(
                {
                    ...
                    "bullets": [
                        ...
                        f"🛡️ Non-delivery risk: {feature.likelihood_of_non_delivery:.0%}",
                        ...
                        f"💣 Year-1 delivery risk: €{feature.year1_business_value_at_risk:,.0f}",
                    ],
