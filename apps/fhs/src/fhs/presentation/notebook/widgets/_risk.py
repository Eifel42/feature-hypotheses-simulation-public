...
class _RiskMixin:
    ...
    def three_level_risk_summary(
        ...
        *,
        ...
        rows = [
            ...
            (
                "After Development Risk (development failure)",
    ...
    def llp_delivery_table(
        ...
        rows: list[tuple[str, ...]],
        *,
        title: str = "Feature Development Risk Table (all features)",
    ) -> None:
        """Render the standard LLP development-risk table for feature comparison."""
        self.sensitivity(
            rows,
            (
                "Feature",
    ...
    def business_value_loss_by_risk_dimension(
        ...
        *,
        ...
        """Render standardized business-value-loss table for development/market/component/global layers."""
    ...
    def feature_risk_profile_cards(
        ...
        *,
        ...
        _names = layer_names or ["Base", "Development", "Market", "Component", "Global"]
        card_data = []
        for feature in sorted(features, key=lambda f: f.name):
            ...
            if retention >= 60:
                action = "Acceptable risk — proceed with development monitoring"
            elif retention >= 30:
                action = (
    ...
    def portfolio_risk_waterfall_detail(
        ...
        *,
        ...
        waterfall_rows = [
            (
                row.layer.replace("After Delivery", "After Development"),
