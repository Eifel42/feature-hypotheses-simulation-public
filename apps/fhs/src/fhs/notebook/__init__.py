...
class NotebookSetupContext:
    ...
    def fig(self):
        ...
        if _HAS_NOTEBOOK_STYLE:
            from fhs.presentation.notebook import FIG as _fig
...
def notebook_setup(
    ...
    try:
        ...
        get_ipython_fn = getattr(IPython, "get_ipython", None)
...
def _show_config_form(context: ScenarioContext) -> None:
    ...
    def on_save_clicked(_b):
        with status_output:
            ...
            except Exception as e:  # noqa: BLE001 — notebook button handler, must not crash
