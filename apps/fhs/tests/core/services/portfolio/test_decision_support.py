...
def test_strategy_category_cost_share_skips_unknown_feature_names() -> None:
    rows = PortfolioDecisionSupportService.strategy_category_cost_share(
        selected_names=["Unknown Feature"],
        feature_by_name={},
        strategy={},
    )
    assert rows == ()
