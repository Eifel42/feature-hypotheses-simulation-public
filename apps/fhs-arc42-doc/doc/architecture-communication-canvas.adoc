...
[small]#Based on the https://canvas.arc42.org/architecture-communication-canvas[Architecture Communication Canvas] by https://arc42.org[arc42]. +
Architecture Inception Canvas: link:architecture-inception-canvas.html[Architecture Inception Canvas]. +
Assets: link:{github-artifacts-raw}/architecture-communication-canvas.drawio[Architecture Communication Canvas source].#
