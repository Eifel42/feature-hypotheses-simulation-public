...
[small]#arc42 template: https://canvas.arc42.org/architecture-inception-canvas[Architecture Inception Canvas]. +
FHS canvas source: link:{github-artifacts-raw}/architecture-inception-canvas.drawio[draw.io]. +
Related FHS canvas: link:architecture-communication-canvas.html[Architecture Communication Canvas] | link:{github-artifacts-raw}/architecture-communication-canvas.drawio[draw.io]. +
