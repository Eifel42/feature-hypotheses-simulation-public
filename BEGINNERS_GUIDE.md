...
>
> Prefer to read it as a single document with embedded charts and a Why/What/How lens for every notebook? See [PRODUCT-OWNER-CASE-STUDY.md](PRODUCT-OWNER-CASE-STUDY.md) — covers notebooks 01–07 and the advanced track A01/A02.
