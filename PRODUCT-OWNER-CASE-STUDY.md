...
The recommended current portfolio is **H2 Traceability + H3 Expiration Alerts**. The decision still needs development controls, because development failure can remove too much value.
...
### Feature Plan Before Risk

Derived from [blockchain.yaml](../../apps/fhs/notebooks/config/blockchain.yaml):

| Feature | Planned weeks | Planned sprints | Planned dev cost | Cost per sprint | Sprint-ceiling cost (1.5x plan, rounded up) |
|---|---:|---:|---:|---:|---:|
| H1 Simplified UI | 5 | 3 | 75,000 EUR | 30,000 EUR | 150,000 EUR |
| H2 Traceability | 5 | 3 | 55,000 EUR | 22,000 EUR | 110,000 EUR |
| H3 Expiration Alerts | 3 | 2 | 10,509 EUR | 7,006 EUR | 21,018 EUR |
