...
<< [Previous: Notebook 06 - Deployment Cost Risk](06-development-cost-risk-evidence.md) | [Case Study Overview](../PRODUCT-OWNER-CASE-STUDY.md)
...
|:-:|---|---|
| 02 | [Business Value](02-business-value-evidence.md) | How much can each feature deliver? |
| 03 | [Financial Return](03-financial-return-evidence.md) | Is the investment worthwhile? (NPV, IRR) |
| 04 | [Portfolio Optimisation](04-portfolio-and-budget-evidence.md) | Which features should we build at this budget? |
| 05 | [Risk Profile](05-risk-resilience-evidence.md) | What can go wrong and how much value is at risk? |
| 06 | [Deployment Cost Risk](06-development-cost-risk-evidence.md) | Will deployment stay within budget if sprints run late? |
